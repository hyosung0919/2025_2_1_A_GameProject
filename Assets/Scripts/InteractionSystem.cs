...
{
    [Header("상호 작용 설정")]
    public float interactitonRange = 2.0f;                            //상호작용 범위
    ...
    {
        Vector3 checkPosition = playerTransform.position + playerTransform.forward * (interactitonRange * 0.5f);        //플레이어 앞쪽 방향으로 체크
    ...
    void HandleInteractionInput()                                                   //인터랙션 입력 함수
    {
        ...
        {
            currentInteractable.Interact();                                        //행동을 진행한다.
        }
    }
